...
from utils.imdb_core import imdb_id_normalize, imdb_item_normalize, search_media as imdb_search
...
# Modified by Gemini 2.5 Pro | 2025-10-23
    ...
    try:
        ...
        return {
            ...
            'data': {
                ...
                'pagination': page_result # Pass the whole pagination object
            }
        }
